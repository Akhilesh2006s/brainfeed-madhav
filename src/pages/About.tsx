...
const About = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero */}
        <section className="relative min-h-[50vh] md:min-h-[55vh] flex items-end overflow-hidden border-b border-border/60">
          <div
          ...
          <div className="container relative z-10 w-full pb-12 pt-24 md:pb-16 md:pt-28">
            ...
            >
              ...
              <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] text-foreground leading-tight">
              ...
              {editions.map((edition, i) => (
                ...
                >
                  <article className="glass-card overflow-hidden flex flex-col md:flex-row gap-0">
                    <div className="md:w-1/3 flex items-center justify-center bg-secondary/50 overflow-hidden">
